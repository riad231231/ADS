	...
	<div id="page-bg">
		<div>
			...
			<?php endif; ?>
				...
				<?php if ($this['modules']->count('custommenu')) : ?>
					<nav id="custommenu"><?php echo $this['modules']->render('custommenu'); ?></nav>
					<?php endif; ?>
									
					<?php if ($this['modules']->count('menu')) : ?>
					
					<?php if ($this['config']->get('enablestickymenu')) : ?>
				...
				<section id="slideshow" class="grid-block outer"><?php echo $this['modules']->render('slideshow', array('layout'=>$this['config']->get('slideshow'))); ?></section>	
...
<div class="wrapper grid-block">
				...
				<?php if ($this['modules']->count('footer + debug') || $this['config']->get('warp_branding') || $this['config']->get('ppc_branding') || $this['config']->get('totop_scroller')) : ?>
